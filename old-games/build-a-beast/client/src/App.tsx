...
export default function App() {
  ...
  function createRoom() {
    socket.emit("create-room", { hostName: name || "Host", challengeId: selectedChallengeId }, (response: any) => {
  ...
  function joinRoom() {
    socket.emit("join-room", { roomId: joinCode.trim().toUpperCase(), name: name || "Player" }, (response: any) => {
